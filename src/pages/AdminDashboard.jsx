...
const AdminDashboard = () => {
  ...
  const fetchComments = async (videoId) => {
    try {
      const response = await API.get(`api/video/comment/${videoId}`);
  ...
  const fetchVideos = async () => {
    try {
      const response = await API.get(`api/video/getadminvideos/${user._id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await API.post("api/video/upload", form, {
  ...
  const handleDelete = async (e) => {
    ...
    try {
      await API.delete(`api/video/delete/${videoId}`);
      fetchVideos();
    } catch (err) {
        ...
        >
          ...
          <div className="form-group">
            ...
            <input
              ...
              onChange={handleInputChange}
              placeholder="No hashtags (comma separated)"
            />
          </div>
        ...
        <div className="admin-videos-grid">
          {videos.map((video) => (
            ...
            >
              ...
              <button onClick={handleCommentClick} className="comments-btn">
                {activeVideoId === video._id ? "Hide Comments" : "See Comments"}
              </button>
